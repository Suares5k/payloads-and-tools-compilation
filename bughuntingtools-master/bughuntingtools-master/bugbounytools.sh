...
echo "${BLUE} installing dnsX${RESET}"
...
echo "${BLUE} installing fprobe${RESET}"
GO111MODULE=on go get -u github.com/theblackturtle/fprobe
echo "${BLUE} done${RESET}"
echo ""

echo "${BLUE} installing crlfuzz${RESET}"
GO111MODULE=on go get -v github.com/dwisiswant0/crlfuzz/cmd/crlfuzz
echo "${BLUE} done${RESET}"
echo ""

echo "${BLUE} installing CorsMe${RESET}"
...
echo "${BLUE} installing Subfinder${RESET}"
GO111MODULE=on go get -u -v github.com/projectdiscovery/subfinder/v2/cmd/subfinder
wget https://gist.githubusercontent.com/KathanP19/6801aaa838f5b03d0b10cfc85775ace6/raw/ab2a62a46a5e2793ff6101c3f47ce2af9912b510/sub.sh -P ~/Desktop/
echo "${BLUE} done${RESET}"
echo ""

echo "${BLUE} installing Go-Dork${RESET}"
GO111MODULE=on go get -v github.com/dwisiswant0/go-dork/...
echo "${BLUE} done${RESET}"
echo ""

echo "${BLUE} ORhunter${RESET}"
git clone https://github.com/PushpenderIndia/ORhunter.git ~/tools/ORhunter
cd ~/tools/ORhunter
pip3 install numpy requests
echo "${BLUE} done${RESET}"
echo ""

echo "${BLUE} dnsgen${RESET}"
...
echo "${BLUE} 403-bypasser${RESET}"
git clone https://github.com/iamj0ker/bypass-403.git ~/tools/bypass-403
cd ~/tools/bypass-403
chmod +x bypass-403.sh
echo "${BLUE} done${RESET}"
echo ""

echo "${BLUE} JSFScan.sh${RESET}"
